    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("This is a ");
    			a0 = element("a");
    			a0.textContent = "SvelteKit";
    			t4 = text(" app. You can make your own by typing the\n\t\tfollowing into your command line and following the prompts:");
    			t5 = space();
    			pre = element("pre");
    			pre.textContent = "npm init svelte";
    			t7 = space();
    			p1 = element("p");
    			p1.textContent = "The page you're looking at is purely static HTML, with no client-side interactivity needed.\n\t\tBecause of that, we don't need to load any JavaScript. Try viewing the page's source, or opening\n\t\tthe devtools network panel and reloading.";
    			t9 = space();
    			p2 = element("p");
    			t10 = text("The ");
    			a1 = element("a");
    			a1.textContent = "TODOs";
    			t12 = text(" page illustrates SvelteKit's data loading and form handling. Try using\n\t\tit with JavaScript disabled!");
    			add_location(h1, file$1, 1, 1, 23);
    			attr_dev(a0, "href", "https://kit.svelte.dev");
    			add_location(a0, file$1, 4, 12, 65);
    			add_location(p0, file$1, 3, 1, 49);
    			add_location(pre, file$1, 8, 1, 223);
    			add_location(p1, file$1, 10, 1, 252);
    			attr_dev(a1, "href", "/todos");
    			add_location(a1, file$1, 17, 6, 511);
    			add_location(p2, file$1, 16, 1, 501);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file, 8, 1, 233);
    			add_location(div, file, 13, 1, 337);
    		},
    		m: function mount(target, anchor) {

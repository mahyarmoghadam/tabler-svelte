				...
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="./icons.html">
							...
							<span class="nav-link-title"> 2016 icons </span>
						</a>
					</li>
					<li class="nav-item dropdown">
						<a
							...
							<span class="nav-link-icon d-md-none d-lg-inline-block"
								...
								<svg
									...
									><path stroke="none" d="M0 0h24v24H0z" fill="none" /><circle
										cx="12"
										cy="12"
										r="4" /><circle cx="12" cy="12" r="9" /><line
										x1="15"
										y1="15"
										x2="18.35"
										y2="18.35" /><line x1="9" y1="15" x2="5.65" y2="18.35" /><line
										x1="5.65"
										y1="5.65"
										x2="9"
										y2="9" /><line x1="18.35" y1="5.65" x2="15" y2="9" /></svg>
							</span>
							<span class="nav-link-title"> Help </span>
						</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="./docs/index.html"> Documentation </a>
							...
							<span class="input-icon-addon">
								...
								<svg
									...
									><path stroke="none" d="M0 0h24v24H0z" fill="none" /><circle
										cx="10"
										cy="10"
										r="7" /><line x1="21" y1="21" x2="15" y2="15" /></svg>
							</span>
							<input
								type="text"
								value=""
